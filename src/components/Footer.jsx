    ...
    <>
      <footer className="site-footer">
        ...
        <div className="copyright">
          <p>&copy; {currentYear} Opération SAJ - Tous droits réservés</p>
        </div>
          ...
          <div className="modal-content">
            ...
            <div className="legal-content">
              <p>
                ...
                https://chrstn67.github.io/course-orientation-SAJ-Molsheim/
                l'identité des différents intervenants dans le cadre de sa
                réalisation et de son suivi: Propriétaire du site : Christian
                HUMBERT - Contact :<i>chrstn.hmbrt67@outlook.com</i> - Hébergeur
                : GitHub
              </p>
              ...
              <p>
                ...
                https://chrstn67.github.io/course-orientation-SAJ-Molsheim/.
                Christian HUMBERT décline toute responsabilité quant à
                ...
                son insu. Des espaces interactifs (espace contact) sont à la
              ...
              <p>
                ...
                l'utilisateur du
                sitehttps://chrstn67.github.io/course-orientation-SAJ-Molsheim/
                dispose d'un droit d'accès, de modification et de suppression
                des informations collectées. Pour exercer ce droit, envoyez un
              ...
              <p>
                ...
                vershttps://chrstn67.github.io/course-orientation-SAJ-Molsheim/.
              </p>

              <p>
                6 - Droit applicable et attribution de juridiction : Tout litige
                en relation avec l'utilisation du site
                https://chrstn67.github.io/course-orientation-SAJ-Molsheim/ est
